...
`ai-for-science` `ai4s` `ai4science` `awesome` `awesome-list` `bioinformatics` `scientific-ai`
...
<sub>🔭 Discovered 2026-05-07 · [View on GitHub](https://github.com/ai-boost/awesome-ai-for-science) · [← Back to AI/ML](./README.md)</sub>
