...
**Value:** cuga-project/cuga-agent helps connect AI assistants to real tools and data through a standard protocol.
...
<sub>🔭 Discovered 2026-06-28 · [View on GitHub](https://github.com/cuga-project/cuga-agent) · [← Back to Mcp](./README.md)</sub>
