...
Bluesky Social — кроссплатформенное мобильное приложение (Web, iOS, Android) с открытым исходным кодом, позволяющее пользователям взаимодействовать в децентрализованной социальной сети Bluesky. Проект реализует клиентскую часть протокола AT Protocol, обеспечивая быстрый и безопасный доступ к ленте, публикацию сообщений, подписки и управление профилем.
...
**Value:** bluesky-social/social-app may be useful when its README and activity match a concrete workflow.
