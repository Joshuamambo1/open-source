...
| Category | Projects | |
|---|---|---|
| 🤖 **AI/ML** | 3719 | [Browse →](./aiml/) |
| 📦 **Misc** | 1987 | [Browse →](./misc/) |
| 🎨 **Frontend** | 1077 | [Browse →](./frontend/) |
| 🧩 **Orchestration** | 1000 | [Browse →](./orchestration/) |
| 🔧 **DevTools** | 584 | [Browse →](./devtools/) |
| 🏷️ **Mcp** | 555 | [Browse →](./mcp/) |
...
| 🏷️ **Database** | 140 | [Browse →](./database/) |
