...
| Category | Projects | |
|---|---|---|
| 🤖 **AI/ML** | 3571 | [Browse →](./aiml/) |
| 📦 **Misc** | 1867 | [Browse →](./misc/) |
| 🎨 **Frontend** | 1013 | [Browse →](./frontend/) |
| 🧩 **Orchestration** | 966 | [Browse →](./orchestration/) |
| 🔧 **DevTools** | 568 | [Browse →](./devtools/) |
| 🏷️ **Mcp** | 505 | [Browse →](./mcp/) |
| ⚙️ **Backend** | 491 | [Browse →](./backend/) |
| ⛓️ **Crypto** | 390 | [Browse →](./crypto/) |
| 🏷️ **Automation** | 319 | [Browse →](./automation/) |
...
| 🏷️ **Database** | 117 | [Browse →](./database/) |
