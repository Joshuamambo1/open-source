...
| Category | Projects | |
|---|---|---|
| 🤖 **AI/ML** | 6308 | [Browse →](./aiml/) |
| 📦 **Misc** | 3557 | [Browse →](./misc/) |
| 🎨 **Frontend** | 1672 | [Browse →](./frontend/) |
| 🧩 **Orchestration** | 1217 | [Browse →](./orchestration/) |
| ⚙️ **Backend** | 1043 | [Browse →](./backend/) |
| 🔧 **DevTools** | 993 | [Browse →](./devtools/) |
