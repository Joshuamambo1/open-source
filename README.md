...
| Category | Projects | |
|---|---|---|
| 🤖 **AI/ML** | 3810 | [Browse →](./aiml/) |
| 📦 **Misc** | 2065 | [Browse →](./misc/) |
| 🎨 **Frontend** | 1103 | [Browse →](./frontend/) |
| 🧩 **Orchestration** | 1017 | [Browse →](./orchestration/) |
| 🔧 **DevTools** | 599 | [Browse →](./devtools/) |
| 🏷️ **Mcp** | 581 | [Browse →](./mcp/) |
| ⚙️ **Backend** | 523 | [Browse →](./backend/) |
...
| 🏷️ **Database** | 148 | [Browse →](./database/) |
