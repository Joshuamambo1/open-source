...
| Category | Projects | |
|---|---|---|
| 🤖 **AI/ML** | 3980 | [Browse →](./aiml/) |
| 📦 **Misc** | 2203 | [Browse →](./misc/) |
| 🎨 **Frontend** | 1170 | [Browse →](./frontend/) |
| 🧩 **Orchestration** | 1074 | [Browse →](./orchestration/) |
| 🔧 **DevTools** | 631 | [Browse →](./devtools/) |
| 🏷️ **Mcp** | 626 | [Browse →](./mcp/) |
| ⚙️ **Backend** | 559 | [Browse →](./backend/) |
